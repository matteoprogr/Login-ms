package com.ms.LoginAuthetication.advice;

import com.ms.LoginAuthetication.exception.BadRequestCustomException;
import com.ms.LoginAuthetication.exception.DataExistException;
...
public class ErrorHandler {
    ...
    public final ResponseEntity<Response<Object>> handleGeneralExceptions(Exception ex){
        ...
        return new ResponseEntity<>(mappingError(HttpStatus.INTERNAL_SERVER_ERROR.value(),
                HttpStatus.CONFLICT.getReasonPhrase(),errors),new HttpHeaders(),HttpStatus.CONFLICT);
    }
